    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-6 sm:p-10 space-y-6 text-slate-700 text-sm leading-relaxed">
        ...
        <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3 text-amber-900 text-xs">
          ...
          <p>
            The information and computational results provided by Fast Calculator are for general educational, illustrative, and informational purposes only. They do not constitute formal financial, taxation, legal, medical, or real estate advice.
          </p>
        </div>

        <h2 className="text-lg font-bold text-slate-900 pt-2">1. Financial, Loan &amp; Tax Disclaimer</h2>
        <p>
          Calculations produced by our Loan Calculator, EMI Calculator, Simple/Compound Interest Calculators, and GST Calculator are estimates based on user-supplied numbers and standard mathematical formulas. Actual bank rates, amortizations, processing fees, insurance surcharges, and tax withholdings may vary depending on local banking regulations and specific lender terms. Users should verify official terms directly with their banking or certified tax accounting professional before executing financial agreements.
        </p>
        ...
        <p>
          Land conversions (such as Marla to Square Feet and Acre to Kanal) provide standard options for both modern urban developments (225 sq ft/Marla) and traditional registers (272.25 sq ft/Marla). Always confirm official deeds and local surveyor demarcation before buying or selling property.
        </p>

        <h2 className="text-lg font-bold text-slate-900 pt-2">4. Limitation of Liability</h2>
        <p>
          Under no circumstances shall Fast Calculator, its authors, or operators be held liable for any direct, indirect, incidental, or consequential damages resulting from reliance on the computational outputs, inaccuracies, or downtime of this website.
        </p>
      </div>
    </div>
  );
